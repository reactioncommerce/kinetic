  ...
  return (
    <>
      ...
      <Dialog open={open} onClose={() => setOpen(false)} maxWidth="xl" PaperProps={{ style: { width: '50%' } }}>
        <DialogTitle variant="h6" fontWeight={500} sx={{ bgcolor: 'background.light', pb: 0 }}>
          System Information
        </DialogTitle>
          ...
          <Paper sx={{ width: '100%', overflow: 'hidden' }}>
            <TableContainer sx={{ maxHeight: 800 }}>
              <Table stickyHeader size="small" aria-label="system information table">
                <TableHead>
                  <TableRow>
                    <TableCell sx={{ p: '10px', pl: '25px', bgcolor: 'background.light', color: 'grey.700' }}>
                      Name
                    </TableCell>
                    <TableCell sx={{ bgcolor: 'background.light', color: 'grey.700' }} align="right">
                      Version
                    </TableCell>
                  </TableRow>
                </TableHead>
