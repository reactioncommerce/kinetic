...
export type GetViewerQuery = {
  ...
  viewer?: {
    ...
    adminUIShops?: Array<{
      ...
      brandAssets?: {
        __typename?: 'ShopBrandAssets'
        navbarBrandImage?: { __typename?: 'ImageSizes'; large?: string | null } | null
      } | null
      shopLogoUrls?: { __typename?: 'ShopLogoUrls'; primaryShopLogoUrl?: string | null } | null
    } | null> | null
  } | null
}
...
export type CreateShopMutation = {
  __typename?: 'Mutation'
  createShop: { __typename?: 'CreateShopPayload'; shop: { __typename?: 'Shop'; _id: string } }
}
...
export const GetViewerDocument = `
  ...
  viewer {
    ...
    `
export const useGetViewerQuery = <TData = GetViewerQuery, TError = unknown>(
  client: GraphQLClient,
...
export const CreateShopDocument = `
  ...
  createShop(input: $input) {
    ...
    `
export const useCreateShopMutation = <TError = unknown, TContext = unknown>(
  client: GraphQLClient,
  ...
  useMutation<CreateShopMutation, TError, CreateShopMutationVariables, TContext>(
    ...
    (variables?: CreateShopMutationVariables) =>
      fetcher<CreateShopMutation, CreateShopMutationVariables>(client, CreateShopDocument, variables, headers)(),
    options
  )
